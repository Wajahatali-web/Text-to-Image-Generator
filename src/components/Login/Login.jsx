        ...
        <div className='fixed top-0 left-0 right-0  bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
            <form action="" className='relative bg-white p-10 rounded-xl text-slate-500'>
                ...
                <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
                    ...
                    <input className='outline-none text-sm' type="text" placeholder='Password' />
                </div>

                {state === 'Login' ? <p className='text-sm text-blue-600 my-4 cursor-pointer'>Forget Passowrd</p> : <p className='my-4'></p>}
